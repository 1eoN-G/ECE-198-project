...
#define MOTOR2_CCW_PIN GPIO_PIN_9  // PA9
...
void controlBothMotors(int motor1Direction, int motor2Direction)
{
    ...
    case 1: // Clockwise
        ...
        HAL_GPIO_WritePin(MOTOR_GPIO_PORT, MOTOR2_CCW_PIN, GPIO_PIN_RESET);
        break;
    case -1: // Counterclockwise
        HAL_GPIO_WritePin(MOTOR_GPIO_PORT, MOTOR2_CW_PIN, GPIO_PIN_RESET);
        HAL_GPIO_WritePin(MOTOR_GPIO_PORT, MOTOR2_CCW_PIN, GPIO_PIN_SET);
        break;
    default: // Stop
        HAL_GPIO_WritePin(MOTOR_GPIO_PORT, MOTOR2_CW_PIN, GPIO_PIN_RESET);
        HAL_GPIO_WritePin(MOTOR_GPIO_PORT, MOTOR2_CCW_PIN, GPIO_PIN_RESET);
